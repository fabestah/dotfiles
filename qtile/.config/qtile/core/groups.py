...
workspaces = [
        {"name": workspace_names[0], "key": "1", "matches": [Match(wm_class="firefox"), Match(wm_class="librewolf")], "lay": "monadtall", "init": True},
        ...
        {"name": workspace_names[4], "key": "5", "matches": [Match(wm_class="Spotify")], "lay": "monadtall", "init": True},
